  ...
  <a href="#" class="close">&times;</a>
   ...
   $locations = json_decode($html);
    ...
    $body .= $locations->$loc->name.'<b></div>
      ...
      <button data-reveal-id="confirm" type="button" class="tiny round alert small-3 columns" id="'.$locations->$loc->id.'"><i class="icon ion-ios-trash-outline"style="font-size: 30px;"></i></button>
      <button type="button" onclick=viewgraph("'.$link.'") class="tiny round info small-3 small-offset-1 columns"><i class="icon ion-stats-bars" style="color:#000;font-size: 30px;"></i></button>
      <hr></div>';
